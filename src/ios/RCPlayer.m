...
//
//            NSURL *findedUrl = [self urlOfPlayerItem:findedItem];
//
//            for (int i = 0; i < [player.items count]; i++) {
//                NSURL *currentUrl = [self urlOfPlayerItem:player.items[i]];
//                if (currentUrl.absoluteString == findedUrl.absoluteString) {
